...
var React = require('react'),
      ...
      getState: function() {
        return {
          resolved: Object.keys(t).reduce(function(e, t) {
            return Object.assign(e, defineProperty({}, t, !0))
          }, {}),
          errors: n,
        }
      },
  ...
  AsyncComponentProvider = (function(e) {
    function t() {
      return (
      ...
      createClass(t, [
        {
          ...
          value: function() {
            ;(this.asyncContext =
              this.props.asyncContext || createAsyncContext()),
...
;(AsyncComponentProvider.propTypes = {
  ...
  rehydrateState: PropTypes.shape({ resolved: PropTypes.object }),
}),
...
function asyncComponent(e) {
  var t,
    n,
    o = e.name,
    r = e.resolve,
    s = e.autoResolveES2015Default,
    i = void 0 === s || s,
    u = e.serverMode,
    a = void 0 === u ? 'resolve' : u,
    c = e.LoadingComponent,
    l = e.ErrorComponent
  if (-1 === validSSRModes.indexOf(a))
  ...
  return (
    (n = t = (function(e) {
      function t() {
        ...
        return (e.state = { resolving: d.resolving }), e
      }
      return (
        inherits(t, e),
        createClass(t, [
            ...
            value: function() {
              return {
                asyncComponentsAncestor:
                  null == d.asyncComponents
                    ? null
                    : { isBoundary: 'boundary' === a },
              }
            },
          },
          {
            key: 'componentWillMount',
            value: function() {
              null != this.context.asyncComponents &&
                ((d.asyncComponents = this.context.asyncComponents),
                (d.asyncComponentsAncestor = this.context.asyncComponentsAncestor),
                d.id || (d.id = this.context.asyncComponents.getNextId()))
            },
          },
          {
            key: 'bootstrap',
            value: function() {
              ...
              if ('browser' === p) {
                var n = d.asyncComponents,
                  o = n.shouldRehydrate,
                  r = (0, n.getError)(d.id)
                return r ? ((d.error = r), !1) : !!o(d.id) && t()
              }
              var s =
                null != d.asyncComponentsAncestor &&
                d.asyncComponentsAncestor.isBoundary
              return 'defer' !== a && !s && t()
            },
          },
          {
            ...
            value: function() {
              ...
              return (function() {
                if (null == d.resolver) {
                  d.resolving = !0
                  try {
                    d.resolver = Promise.resolve(r())
                  } catch (e) {
                    d.resolver = Promise.reject(e)
                  }
                }
                return d.resolver
              })()
                .then(function(e) {
                  return (
                    null != d.asyncComponents &&
                      d.asyncComponents.resolved(d.id),
                    (d.module = e),
                    (d.error = null),
                    (d.resolving = !1),
                    e
                ...
                .catch(function(e) {
                  ...
                  null != d.asyncComponents &&
                    d.asyncComponents.failed(d.id, t),
                    (d.error = t),
                    (d.resolving = !1),
                    l || console.error(t)
                })
                .then(function(t) {
                  if (!e.unmounted)
                    return (
                      e.context.reactAsyncBootstrapperRunning ||
                        'browser' !== p ||
                        e.forceUpdate(),
                      t
                    )
            ...
            value: function() {
              ...
              var n,
                ...
                n.default
                  ...
                  : n)
              return o
                ? React__default.createElement(o, this.props)
                : c ? React__default.createElement(c, this.props) : null
            },
          },
        ]),
        t
    ...
    (t.displayName = o || 'AsyncComponent'),
    (t.contextTypes = {
      asyncComponentsAncestor: PropTypes.shape({ isBoundary: PropTypes.bool }),
      asyncComponents: PropTypes.shape({
        getNextId: PropTypes.func.isRequired,
        resolved: PropTypes.func.isRequired,
        shouldRehydrate: PropTypes.func.isRequired,
