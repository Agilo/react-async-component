...
var AsyncComponentProvider = (function(_Component) {
  ...
  function AsyncComponentProvider() {
    ...
    return possibleConstructorReturn(
      this,
      (
        AsyncComponentProvider.__proto__ ||
        Object.getPrototypeOf(AsyncComponentProvider)
        ...
        return {
          asyncComponents: {
            ...
            getError: function getError(id) {
              return (
                _this2.rehydrateState.errors && _this2.rehydrateState.errors[id]
              )
            },
          },
        }
...
function asyncComponent(config) {
  ...
  var name = config.name,
    ...
    autoResolveES2015Default =
      _config$autoResolveES === undefined ? true : _config$autoResolveES,
  ...
  var es6Resolve = function es6Resolve(x) {
    return autoResolveES2015Default &&
      x != null &&
      (typeof x === 'function' ||
  ...
  return (
    (_temp = _class = (function(_React$Component) {
      ...
      function AsyncComponent() {
        ...
        var _this = possibleConstructorReturn(
          this,
          (
            AsyncComponent.__proto__ || Object.getPrototypeOf(AsyncComponent)
          ).call(this),
        )
      ...
      createClass(AsyncComponent, [
          ...
          value: function resolveModule() {
            ...
            return getResolver()
              ...
              .then(function(result) {
                ...
                if (
                  !_this3.context.reactAsyncBootstrapperRunning &&
                  env === 'browser'
                ) {
                  _this3.forceUpdate()
                }
        ...
        },
        {
          ...
          value: function render() {
            ...
            return Component
              ? React__default.createElement(Component, this.props)
              : LoadingComponent
    ...
    (_class.displayName = name || 'AsyncComponent'),
    (_class.contextTypes = {
